...
;;   (is (= (->  statement privat-manager.privat.parser/parse-statement privat-manager.privat.api/unpack-statements)
...
;; (map privat-manager.privat.parser/parse-statement cleared-statement)
